...
This is a set of 8 Super Mario Land rom hacks. Each features unique levels, graphical updates, and infinite lives.

Most of them are updated to use the graphics from my recent SML DX DMG release. A few of them feature heavy graphic changes. In these cases the only change was to update the Mario and Daisy sprites.

Since asking "Do you want to play 8 new versions of Super Mario Land" is a bit of a heavy statement, here are my recommendations.
